...
and $V$ is the subset of cells which are able to replicate (i.e, they have an unoccupied neighbor). Maintaining the list of cells with a free neighbor can be expensive, so our simulation algorithm approximates the parameter of the exponential distribution with 
